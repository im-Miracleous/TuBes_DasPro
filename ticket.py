...
# Fungsi ini membaca data kursi dari file CSV dan mengembalikan informasi terkait bioskop, jumlah tiket, daftar tempat duduk, dan status tempat duduk.
    # Kamus Lokal
    # data : variabel untuk dictionary untuk menyimpan data yang dibaca dari file (dict)
    # filename : variabel untuk nama file CSV yang akan dibaca (str)
    ...
    # kursi_raw : variabel untuk string yang berisi daftar kursi yang dibaca dari file (str)
    # state_raw : variabel untuk string yang berisi status kursi yang dibaca dari file (str)
...
## PROGRAM UTAMA ##
    # Kamus Lokal
    # data_tiket : variabel untuk dictionary yang berisi data tiket yang dibaca dari file (dict)
    # judul_film : variabel untuk judul film yang dibaca dari data_tiket (str)
    # tipe_bioskop_raw : variabel untuk tipe bioskop yang dibaca dari data_tiket (str)
    # jumlah_tiket : variabel untuk jumlah tiket yang dibaca dari data_tiket (int)
    # daftar_tempat_duduk : variabel untuk daftar tempat duduk yang dibaca dari data_tiket (list of str)
    # studio : variabel untuk studio yang dibaca dari data_tiket (str)
    # kursi_str : variabel untuk string yang berisi daftar kursi yang sudah dipesan (str)
    # tipe_bioskop_str : variabel untuk string yang berisi tipe bioskop (str)
    # harga_satuan : variabel untuk harga per tiket berdasarkan tipe bioskop (int)
    # total_harga : variabel untuk total harga tiket yang harus dibayar (int)
    # harga_str : variabel untuk string yang berisi total harga dalam format mata uang Rupiah (str)
    # waktu_sekarang : variabel untuk objek datetime untuk mendapatkan waktu saat ini (datetime)
    # nama_hari_ini : variabel untuk nama hari saat ini (str)
    # tanggal_str : variabel untuk string yang berisi tanggal saat ini dalam format 'Hari, DD-MM-YYYY' (str)
    # waktu_str : variabel untuk string yang berisi waktu saat ini dalam format 'HH:MM' (str)
def main():
